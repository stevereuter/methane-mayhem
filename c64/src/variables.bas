...
# sprite date pointers starting at 57344 (x-49152)/64 = y
let @spriteSelector = 128
let @spriteMeteor = @spriteSelector + 1
# let @spriteMeteor2 = @spriteSelector + 2
let @spriteFire = @spriteSelector + 3
# let @spriteFire2 = @spriteSelector + 4
let @spriteTreeGrow = @spriteSelector + 5
# let @spriteTreeGrow2 = @spriteSelector + 6
let @spriteUFO = @spriteSelector + 7
let @spriteBeam = @spriteSelector + 8
# let @spriteBeam2 = @spriteSelector + 9
let @spritePoof = @spriteSelector + 10
# let @spritePoof2 = @spriteSelector + 11
# let @spritePoof3 = @spriteSelector + 12
let @spriteGas = @spriteSelector + 13
